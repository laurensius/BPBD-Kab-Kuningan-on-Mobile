...
public class RecyclerInfoBencanaClickListener implements RecyclerView.OnItemTouchListener {
    ...
    public RecyclerInfoBencanaClickListener(Context context, OnItemClickListener listener){
        mListener = listener;
