...
public class RecyclerLaporanMasyarakatClickListener implements RecyclerView.OnItemTouchListener {
    ...
    public RecyclerLaporanMasyarakatClickListener(Context context, OnItemClickListener listener){
        mListener = listener;
